...
- [courseraまとめ](http://trafalbad.hatenadiary.jp/entry/2017/03/02/193616)
- [機械学習入門記事まとめ](http://piikaachuu.hatenablog.com/entry/2017/06/21/090919)
- [Googleの開発者が作った3時間でディープラーニング(深層学習)をスライドとムービーで学べる集中レッスン](http://gigazine.net/news/20170127-learning-tensorflow-3hours/)
- [ニューラルネットワークの考え方](http://logics-of-blue.com/time-series-analysis-by-nnet/)
- [「TensorFlow Tutorialの数学的背景」シリーズの目次 - めもめも](http://enakai00.hatenablog.com/entry/2016/02/29/121321)
...
- [colormind 最適な色の組み合わせを提示](http://colormind.io/)

## Zoo

- [Neural Network](http://postd.cc/neural-network-zoo/)
- [Neural Network](http://postd.cc/neural-network-zoo-latter/)
- [GAN](https://deephunt.in/the-gan-zoo-79597dc8c347)
- [Caffe2 Model](https://caffe2.ai/docs/zoo.html)
- [Tensorflow Detection Model](https://github.com/tensorflow/models/blob/master/object_detection/g3doc/detection_model_zoo.md)

## Cheat Sheets

- [keras](https://s3.amazonaws.com/assets.datacamp.com/blog_assets/Keras_Cheat_Sheet_Python.pdf)
- [octave2numpy](https://docs.scipy.org/doc/numpy-dev/user/numpy-for-matlab-users.html)

## Optimisations

- [Hyperopt ベイズ最適化](http://segafreder.hatenablog.com/entry/2017/06/10/185425)
- [GridSearchCV](http://qiita.com/SE96UoC5AfUt7uY/items/c81f7cea72a44a7bfd3a)
- [Boruta 重要変数選択]()

## Architectures

- [data Lake](https://www.slideshare.net/AmazonWebServicesJapan/aws-70254977)
- [cookpad](https://speakerdeck.com/ayemos/machine-learning-ops-at-cookpad-1)

## Others

- [機械学習事例](https://aiexperiments.withgoogle.com/)
- [tensor2tensor](http://shiropen.com/2017/06/24/26070)